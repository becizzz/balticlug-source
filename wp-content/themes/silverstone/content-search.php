	...
	<footer class="entry-footer">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			<?php
				...
				$categories_list = get_the_category_list( __( ', ', 'silverstone' ) );
			...
			<?php
				/* translators: used between list items, there is a space after the comma */
				$tags_list = get_the_tag_list( '', __( ', ', 'silverstone' ) );
				if ( $tags_list ) :
			?>
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'silverstone' ), __( '1 Comment', 'silverstone' ), __( '% Comments', 'silverstone' ) ); ?></span>
		<?php endif; ?>
