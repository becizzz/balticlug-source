...
= 1.1 =
-Use add_theme_support( 'custom-header')and add_theme_support( 'custom-background' )
-get_stylesheet_uri() rather than bloginfo( 'stylesheet_url' )
-filter wp_title() 
-use theme-slug as textdomain
